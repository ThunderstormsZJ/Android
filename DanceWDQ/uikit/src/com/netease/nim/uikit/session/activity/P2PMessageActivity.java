...
public class P2PMessageActivity extends BaseMessageActivity {
    ...
    public static void start(Context context, String contactId, SessionCustomization customization, String nickName) {
        Intent intent = new Intent();
        intent.putExtra(Extras.EXTRA_ACCOUNT, contactId);
        intent.putExtra(Extras.EXTRA_ACCOUNTNICKNAME, nickName);
        intent.putExtra(Extras.EXTRA_CUSTOMIZATION, customization);
        intent.setClass(context, P2PMessageActivity.class);
        intent.addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP);
    ...
    private void requestBuddyInfo() {
        ...
        if (titleName.startsWith("userid") || titleName.startsWith("orgid")) {
