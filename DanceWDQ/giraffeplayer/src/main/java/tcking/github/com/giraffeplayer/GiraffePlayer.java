...
public class GiraffePlayer {
    ...
    public GiraffePlayer(final Activity activity, View itemView) {
        IjkMediaPlayer.loadLibrariesOnce(null);
        IjkMediaPlayer.native_profileBegin("libijkplayer.so");
        this.activity = activity;
        screenWidthPixels = activity.getResources().getDisplayMetrics().widthPixels;
        $ = new Query(activity, itemView);
        if (itemView == null) {
...
//                        Toaster.show("download rate:" + extra);
        ...
        if (itemView == null) {
            ...
            seekBar = (SeekBar) itemView.findViewById(R.id.app_video_seekBar);
        }
        seekBar.setMax(1000);
...
//        View liveBox = $.id(R.id.app_video_box);
        View liveBox = null;
        if (itemView == null) {
            liveBox = activity.findViewById(R.id.app_video_box);
        } else {
            liveBox = itemView.findViewById(R.id.app_video_box);
        ...
        if(itemView==null){
            ...
            initHeight = itemView.findViewById(R.id.app_video_box).getLayoutParams().height;
        }
        hideAll();
    }
    ...
    class Query {
        ...
        public Query(Activity activity, View itemView) {
            this.activity = activity;
