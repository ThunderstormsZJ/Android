...
public class OkHttpClientManager {
    ...
    private static class Holder {
        private static final OkHttpClientManager OKHTTP_MANAGER = new OkHttpClientManager();
    }

    public static OkHttpClientManager getInstance() {
        return Holder.OKHTTP_MANAGER;
    }
    ...
    public class GetDelegate {
        ...
        public Response get(Request request) throws IOException {
            ...
            LogUtil.w(TAG,request.urlString());
    ...
    public class UploadDelegate {
        ...
        private Request buildMultipartFormRequest(String url, File[] files,
            ...
            for (Param param : params) {
                builder.addPart(Headers.of("Content-Param", "form-data; name=\"" + param.key + "\""),
    ...
    public static class ImageUtils {
        ...
        public static Bitmap getBitMapFromNet(String url) {
            ...
            Call call = OkHttpClientManager.getClinet().newCall(request);
