package cn.spinsoft.wdq.widget.wheel;
...
//                    mUpdateHandler.sendEmptyMessageDelayed(0, 60);
    ...
    protected void adjustPositionY() {
        ...
        if (curPosition != mLastSelectPosition) {
            ...
            if (mSelectListener != null) {
                mSelectListener.onSelectChanged(this, mLastSelectPosition);
            }
        }
    ...
    public interface OnSelectItemListener {
        void onSelectChanged(RecycleWheelView wheelView, int position);
    }
}
